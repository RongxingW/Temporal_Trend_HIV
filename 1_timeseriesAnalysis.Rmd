...
late_diag_segmented_results <- analyze_segmented_trend_complete(
  ...
  main_title = "",
  sub_title = "I. HIV notifications, Late diagnosis, 2001-2024",
  family_type = "NB",
  num_changes = 5,
  show_overall = FALSE,  # Don't show overall trend
  show_segment = TRUE   # Don't show segmented trends
...
advanced_diag_segmented_results <- analyze_segmented_trend_complete(
  ...
  main_title = "",
  sub_title = "J. HIV notifications, Advanced diagnosis, 2001-2024",
  family_type = "NB",
  num_changes = 5,
...
# If figure not already created make sure it is not overwritten
if (!file.exists(file.path(figFolder, "Sub_group_segment_plot_2001_2024_20251010.png"))) {
  SaveFigure(figFolder,"Sub_group_segment_plot_2001_2024_20251010", Sub_group_segment_plot)
}
...
library(patchwork)
combined_plot_phn_hiv_rates_2001_24 <- ( fed + pdo ) + plot_layout(heights = c(1, 1))
